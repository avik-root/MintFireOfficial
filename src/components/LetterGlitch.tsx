...
const LetterGlitch = ({
  ...
  const animate = () => {
    ...
    if (now - lastGlitchTime.current >= glitchSpeed) {
      updateLetters();
      drawLetters(); // Draw immediately after update
      lastGlitchTime.current = now;
    }
    
    if (smooth) {
      handleSmoothTransitions(); // This will redraw if needed
    }
  ...
  useEffect(() => {
    ...
    resizeCanvas(); // Call resizeCanvas to initialize everything
    
    let currentAnimationRef: number | null = null;
    ...
    const startAnimation = () => {
        ...
        animate();
        currentAnimationRef = animationRef.current;
    };

    startAnimation(); // Start animation after initial setup
    ...
    const handleResize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        ...
        resizeCanvas();
        startAnimation(); // Restart animation after resize
      }, 100);
    };
